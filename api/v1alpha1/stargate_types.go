...
type StargateSpec struct {
	...
	// DatacenterName is the name of a CassandraDatacenter resource where Stargate should be
	// deployed.
...
type StargateStatus struct {
	...
	// DeploymentName is the name of the Deployment object that was created for this Stargate
	// object.
	// +optional
	DeploymentName *string `json:"deploymentName,omitempty"`

	// ServiceName is the name of the Service object that was created for this Stargate
	// object.
	// +optional
...
//+kubebuilder:printcolumn:name="DC",type=string,JSONPath=`.spec.datacenterName`
